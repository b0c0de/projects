...
WIDGET_TEMPLATE
        )); ?> <aside data-id="a81c" class="u-indent-40 u-sidebar" style="flex-basis: 250px;"><?php if ($sidebar_html) { echo stylingDefaultControls($sidebar_html); } else { ?> <div class="u-block u-indent-30">
        <div class="u-block-container u-clearfix">
